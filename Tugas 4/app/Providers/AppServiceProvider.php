...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::define('show-laporan', function (User $user) {
            return ($user->role == 'admin' || $user->role == 'owner')
                ? Response::allow()
                : Response::deny('Anda tidak memiliki akses melihat laporan.');
        });
        ...
        Gate::define('penerimaan-obat', function (User $user) {
            return ($user->role == 'pelanggan')
                ? Response::allow()
                : Response::deny('Anda tidak memiliki akses penerimaan obat.');
        });
    }
}
